...
Provide an ordered fallback chain; the gateway skips dead/rate-limited routes with circuit-breaker failover.

```bash
python recipes/03-failover-chain/main.py
```
...
**Web version:** https://bharatrouter.com/cookbook/failover-chain
